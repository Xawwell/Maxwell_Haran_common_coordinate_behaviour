...
# Set parameters 
#Maxwell here, we have to dimension to fit Haran's video,
CHECKERBOARD = (10,7) #size of the checkerboard (# of vertices in each dimension, not including those on the edge)
#(10,7)
#original : (28,12)
...
# =================================================================================
#              Original code, and i deleted the first part 
# calibration_flags = cv2.fisheye.CALIB_RECOMPUTE_EXTRINSIC+cv2.fisheye.CALIB_FIX_SKEW #+cv2.fisheye.CALIB_CHECK_COND
# =================================================================================
#
calibration_flags = cv2.fisheye.CALIB_RECOMPUTE_EXTRINSIC#+cv2.fisheye.CALIB_CHECK_COND#cv2.fisheye.CALIB_FIX_SKEW #+cv2.fisheye.CALIB_CHECK_COND
...
K = np.zeros((3, 3))
D = np.zeros((4, 1))
# print("this is K: " + str(K), "and this is D: " + str(D))
